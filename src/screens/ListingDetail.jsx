...
export default function ListingDetail({ user, score, flags, isFavorite, onToggleFavorite, onBack }) {
  return (
    <div className="screen">
      ...
      <div className="screen-body" style={{ paddingTop: 20 }}>
        ...
        <div style={{ fontSize: 13, color: 'var(--color-neutral-600)', margin: '4px 0 12px' }}>{user.gender === 'woman' ? 'Woman' : 'Man'}</div>
